...
def test_net(net,
        ...
        ##INITIALIZE LOSSES AND ARRAYS FOR PREDICTION
        mean_cross_entropy_test=0
        dice_l=0
        y_true=[]
        y_pred=[] ##IS FOR UNET OUTPUTS
        y_pred2=[] ##IS FOR FCN OUTPUTS
        specimen_true=[]
        specimen_pred=[]
        ...
        for i, item in enumerate(test_loader):
            ...
            with torch.no_grad():
                pred_masks,label_pred_embedding = net(img)
                label_pred_embedding=label_pred_embedding.argmax(dim=1)
                ...
                for j in range(batch_size):
                    ...
                    y_pred2.append(label_pred_embedding[j].item())
        ...
        y_true_spec=[]
        y_pred_spec=[] ##IS FOR UNET OUTPUTS
        y_pred_spec2=[] ##IS FOR FCN OUTPUTS
        ...
        for j in range(0,len(y_true), 15):
            ...
            y_pred_spec2.append(pred_label2)
        ...
        confusion_mat2=confusion_matrix(y_true_spec,y_pred_spec2)
        ...
        confusion_mat_norm2=norm(confusion_mat2)

        #COMPUTE MCA
        mca=mean_class_accuracy(confusion_mat) ##IS FOR UNET OUTPUTS
        mca2=mean_class_accuracy(confusion_mat2) ##IS FOR FCN OUTPUTS
        ...
        print("CONFUSION MATRIX EMBED:")
        print(confusion_mat2)
        print("CONFUSION MATRIX EMBED NORM:")
        print(confusion_mat_norm2)
        print("MPA EMBED: ",mca2)
